...
后 Alpha 顺序见 [Post-Alpha 路线图](./docs/interview-workbench-post-alpha-roadmap.md)。下一条
最小任务仅为 **P5-010**：决定是否以及在何种本地优先边界下接入真实简历与岗位说明；在
ADR 获批前不启动 P5-011，不实现真实输入、持久化、候选人画像或自动录用/淘汰路径。
